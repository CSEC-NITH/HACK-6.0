      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <main className="w-full lg:w-2/3">
          ...
          <div className="mb-8">
            <a
              ...
              className="block bg-[#5A2A25] hover:bg-[#4A1C18] transition-colors rounded-lg p-6 sm:p-8 text-center shadow-lg group border-2 border-[#E8A87C]"
            >
              <div className="relative">
                <h3 className="text-[#F2D5C4] text-lg sm:text-xl font-semibold group-hover:scale-105 transition-transform">
                  Registration
                </h3>
              </div>
            </a>
          ...
          <div className="space-y-6 text-[#33110E]">
            ...
            <div>
              <p className="font-bold text-base sm:text-lg mb-3">Eligibility Criteria</p>
            ...
            <div>
              <p className="font-bold text-base sm:text-lg mb-3">Registration Process</p>
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
                <li>
            ...
            {/* Code of Conduct */}
            <div>
              <p className="font-bold text-base sm:text-lg mb-3">Code of Conduct</p>
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
                <li>
            ...
            {/* Submission Rules */}
            <div>
              <p className="font-bold text-base sm:text-lg mb-3">Submission Rules</p>
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
                <li>
        ...
        <aside className="w-full lg:w-1/3">
          <div className="lg:sticky lg:top-24">
            <div className="bg-[#3E1714] text-white p-6 sm:p-8 rounded-lg shadow-lg border border-[#5A2A25]">
              <h3 className="text-[#E8A87C] text-sm sm:text-base font-semibold mb-2">
                HACKATHON ON MOBILE DEVICE and Application Security
              </h3>
              <p className="text-[#E8A87C] text-sm sm:text-base font-semibold mb-4">March 2026</p>
              <p className="text-xs sm:text-sm text-[#F2D5C4]">
                Contact:
                <br />
                <a
